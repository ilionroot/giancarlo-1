...
endereco_curso_nome_municipio = st.text_input("Nome do Município do Endereço do Curso")
...
autorizacao_data_cadastro = st.date_input("Data de Cadastro do Processo de Autorização")
...
reconhecimento_data_publicacao = st.date_input("Data de Publicação do Reconhecimento")
reconhecimento_secao_publicacao = st.text_input("Seção de Publicação do Reconhecimento")
...
renovacao_reconhecimento_numero = st.text_input("Número da Renovação de Reconhecimento")
...
dados_ies_original_curso_pta_nome = st.text_input("Nome da IES Original do Curso PTA")
dados_ies_original_curso_pta_cnpj = st.text_input("CNPJ da IES Original do Curso PTA")
...
data = {
    ...
    "autorizacao_data_protocolo": autorizacao_data_protocolo.strftime("%Y-%m-%d"),
    ...
    "renovacao_reconhecimento_data": renovacao_reconhecimento_data.strftime("%Y-%m-%d"),
